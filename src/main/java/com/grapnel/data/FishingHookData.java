...
public class FishingHookData {
    ...
    public static class ToughnessLevel implements INBTSerializable<CompoundTag> {
        ...
        public int getToughnessLevel() { return toughnessLevel; }

        public void setToughnessLevel(int toughnessLevel) { this.toughnessLevel = toughnessLevel; }
    ...
    public static ToughnessLevel getKineticLevel(Player player) { return player.getData(TOUGHNESS_LEVEL.get()); }
